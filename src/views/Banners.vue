...
export default {
  ...
  methods: {
    ...
    fetchBanners: async function () {
      const result = await this.$store.dispatch("readFromDatabase", "/banners");
    ...
    fetchBigBanner: async function () {
      const result = await this.$store.dispatch("readFromDatabase", "/bigban");
      if (result) {
    ...
    fetchActions: async function () {
      const result = await this.$store.dispatch("readFromDatabase", "/actions");
